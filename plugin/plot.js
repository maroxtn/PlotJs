...
(function() {
    ...
    Plot = function() {
		...
		valCont.innerHTML = '<span id="plotjs-valuesX" style="line-height:'+ (parseInt(options.height,10) / 25) + 'px;position:absolute;left:0;width:50%;height:100%;text-align:center;font-size:12px;">X:&nbsp;&nbsp;</span><span id="plotjs-valuesY" style="line-height:'+ (parseInt(options.height,10) / 25) + 'px;position:absolute;right:0;width:50%;height:100%; text-align:center;font-size:12px;">Y:&nbsp;&nbsp;</span>';
		var valContX = document.getElementById('plotjs-valuesX'),
			valContY = document.getElementById('plotjs-valuesY');
